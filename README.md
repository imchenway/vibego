...
Telegram worker 侧支持 Codex `/goal [objective|pause|resume|clear]`，也可通过主键盘 `🎯 GOAL`
打开轻量管理面板。Goal 的真实状态以 Codex active thread 为准，vibego 不在本地数据库中复制状态。
...
- `/goal [objective|pause|resume|clear]`：仅 Codex worker 可用，用于查看、设置、暂停、恢复或清除当前
