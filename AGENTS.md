...
- **文档语言**: 生成的文档及注释使用简体中文，可考虑使用一些 🌟、✅、❌ 等 emoji 来增加可读性。
...
- 需要用户做出决策或待用户确认问题时，给出待决策项的纯数字编号以及 ABCD 的选项，且必须给出（推荐🌟），方便用户回复你。
...
- 制定需求方案：给出新增功能的行业最佳改造方案、最小改造方案以及你根据项目需求现状逻辑判断的推荐改造方案（至少 3 种，写清优缺点与影响范围）。
...
- 给出新增功能的行业最佳改造方案、最小改造方案以及你根据代码库现状判断的推荐改造方案（至少 3 种，写清优缺点与影响范围）。必要时用图表示。
